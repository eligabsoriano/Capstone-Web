...
const navItems: NavItem[] = [
    ...
    { label: 'Loan Officers', icon: Users, href: '/admin/officers', permission: 'create_loan_officer|manage_loan_officers' },
    { label: 'Admins', icon: UserCog, href: '/admin/admins', superAdminOnly: true },
    { label: 'Applications', icon: ClipboardList, href: '/admin/applications', permission: 'view_analytics' },
    ...
    return (
        <div className="flex flex-col h-full">
            ...
            <div className="h-16 flex items-center px-4 border-b border-sidebar-border">
                {!collapsed ? (
                    <span className="text-lg font-semibold text-sidebar-foreground">MSME Portal</span>
                ) : (
                    <span className="text-lg font-bold text-sidebar-foreground mx-auto">M</span>
                )}
            </div>
