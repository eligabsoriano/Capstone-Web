    ...
    return (
        <TooltipProvider>
            <div className="min-h-screen bg-gray-50">
                ...
                {/* Sidebar - Light theme with border */}
                <aside
                    className={cn(
                        "fixed top-0 left-0 z-50 h-full bg-white border-r border-gray-200 shadow-sm transition-all duration-300 ease-in-out",
                        // Desktop
                        "hidden lg:block",
                ...
                >
                    {/* Header */}
                    <OfficerHeader onMenuClick={toggleMobileMenu} queueCount={queueCount} />
