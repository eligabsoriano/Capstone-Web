...
const AdminAdminsPage = () => (
  <div className="space-y-6">
    <div>
      ...
      <p className="text-muted-foreground">Manage administrator accounts (Super Admin only)</p>
    </div>
    <div className="rounded-lg border bg-card p-8 text-center text-muted-foreground">
...
const AdminWorkloadPage = () => (
  <div className="space-y-6">
    <div>
      ...
      <p className="text-muted-foreground">View and manage loan officer assignments</p>
    </div>
    <div className="rounded-lg border bg-card p-8 text-center text-muted-foreground">
